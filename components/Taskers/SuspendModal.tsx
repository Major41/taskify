// components/Taskers/SuspendModal.tsx
"use client";
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea
                ...
                placeholder="Please provide a detailed reason for suspending this tasker..."
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-sm text-yellow-800">
                <strong>Warning:</strong> Suspending this tasker will prevent
                them from accepting new requests and may affect their current
                ongoing tasks.
              </p>
            </div>
          </div>
